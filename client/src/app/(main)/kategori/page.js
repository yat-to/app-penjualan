...
import { Plus, Package, MoreHorizontal, Filter, Download, ChevronLeft, ChevronRight, Edit, Trash2, X } from 'lucide-react';
import { kategori } from '@/data/dummyKategori';
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {kategori.map((data) => (
                                <tr key={data.id} className="hover:bg-blue-50/30 transition-colors group">
                                    ...
                                    {/* <td className="px-6 py-4">
                                        <span className="text-xs font-medium px-2.5 py-1 bg-gray-100 text-gray-600 rounded-full italic">
                                            {item.kategori}
                                        </span>
                                    </td> */}
                                    {/* <td className="px-6 py-4 text-right">
                                        <span className="text-sm font-bold text-gray-700">Rp{item.harga.toLocaleString('id-ID')}</span>
                                    </td> */}
                                    {/* <td className="px-6 py-4 text-center">
                                        <span className={`text-sm font-semibold ${item.stok <= 10 ? 'text-red-500' : 'text-gray-600'}`}>
                                            {item.stok}
                                        </span>
                                    </td> */}
                                    {/* <td className="px-6 py-4">
                                        <span className={`text-[10px] font-bold px-2 py-1 rounded-md uppercase ${item.stok === 0 ? 'bg-red-100 text-red-600' :
                                            item.stok <= 10 ? 'bg-orange-100 text-orange-600' : 'bg-green-100 text-green-600'
                                            }`}>
                                            {item.status}
                                        </span>
                                    </td> */}
